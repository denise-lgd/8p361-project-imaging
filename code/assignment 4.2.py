...
#pretrained = MobileNetV2(input_shape=input_shape, include_top=False, weights='imagenet') # Initialized from ImageNet weights
pretrained = MobileNetV2(input_shape=input_shape, include_top=False, weights=None) # Randomly initialized
...
model_name = 'transfer_model_assi4_2'
